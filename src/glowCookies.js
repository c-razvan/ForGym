...
class LanguagesGC {
  ...
  init() {
    this.arrLang = {
      ...
      ro: {
        'bannerHeading': 'Folosim sistemul de cookies',
        'bannerDescription': 'Folosim un sistem terț de cookies pentru personalizarea experienței, analizând traficul web.',
        'bannerLinkText': 'Mai multe informații',
        'acceptBtnText': 'De acord',
        'rejectBtnText': 'Respinge',
        'manageText': 'Gestionează cookies'
      },
      bg: {
